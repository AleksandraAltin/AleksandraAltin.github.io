$(document).ready(function() {
    ...
    const translations = {
        en: {
            ...
            synopsisText3: "In each episode, the professor, Civan, and Yaman board the flying vehicle called 'Kaşif'. They enter the human body simulation and explore the miraculous organs created by Allah (God) in the human body. Through this series, each episode introduces an organ, highlighting the manifestations of Allah’s (God's) name and attributes through the human body.",
